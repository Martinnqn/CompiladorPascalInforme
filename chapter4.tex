...
\node[state] (1) at (-3,4) {$VD$};
\node[state] (2) at (3,4) {$VDL\_1$};
\node[state] (3) at (-1,2) {$IL\_1$};
\node[large triangle,yshift={-3mm}] (4) at (-5,2) {$I$};
\node[state] (5) at (-1,0) {$IL$};
\node[state] (6) at (1,-2) {$IL\_1$};
\node[state] (7) at (-3,-2) {$I$};
...
\label{fig:arbol_declaracio_list_var}
\end{figure}
